...
| `c.Spawner.cpu_limit` | The cpu limit for every container. Currently we use `1` |
...
2. The jupyterhub config file of the non-docker version is in "/anaconda3/envs/data8/bin/jupyterhub_config.py".
